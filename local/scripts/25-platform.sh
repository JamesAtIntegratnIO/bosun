...
# That is the entire point of a proving ground, it exercises the code in front
# of you, not whatever was last published, so those two stay in 30-kit.sh and
# are the only things here that are not GitOps.
